...
#ifndef COGIMON_REPORTING_COMPONENT_HPP
#define COGIMON_REPORTING_COMPONENT_HPP
...
namespace cogimon
{
     ...
     * @code
     ...
     <properties>
        ...
        <struct name="ReportData" type="RTT::PropertyBag">
    ...
    protected:
        ...
        RTT::Property<RTT::PropertyBag>   report_data;
